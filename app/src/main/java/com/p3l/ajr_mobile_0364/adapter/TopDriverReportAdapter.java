...
public class TopDriverReportAdapter extends
        RecyclerView.Adapter<TopDriverReportAdapter.ViewHolder> {
    private List<Report> reportList;
    private Context context;

    public TopDriverReportAdapter(List<Report> reportList, Context context) {
